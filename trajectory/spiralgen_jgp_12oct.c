...
/************************************************************/
  ...
  kx    = (double*) mxCalloc(subrast*maxarray,sizeof(double));
  ky    = (double*) mxCalloc(subrast*maxarray,sizeof(double));
  kz    = (double*) mxCalloc(subrast*maxarray,sizeof(double));
  gsign = (double*) mxCalloc(subrast*maxarray,sizeof(double));
				 ...
				 int nrhs, const mxArray *prhs[])
{
  ...
  bnispiralgen(float* spparams, int maxarray, float *gxarray, float *gyarray, float *gzarray, 
                  int *spgrad_na, int *spgrad_nb, int *spgrad_nc, int *spgrad_nd)
